...
public class LevelTwoSettings {
    ...
    public LevelTwoSettings(){
        ...
        for(int i = 0; i < 5; i++){
            bricksCoords.add(new int[]{200 + i * 95, tabletHeight / 3 - 250 + 240});
        }
        ...
        goldsCoords.add(new int[]{400, tabletHeight / 3 - 250 + 240 - 60});
