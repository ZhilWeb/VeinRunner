...
public class Sprite {
    ...
    public Sprite(double x, double y, double velocityX, double velocityY,  Rect initialFrame, Bitmap bitmap, boolean isHuman, boolean isBrick) {
        this.x = x;
        this.y = y;
        this.velocityX = velocityX;
        this.velocityY = velocityY;
    ...
    public boolean isPointInside (int pointX, int pointY){
        if ( pointX >= this.x && pointX <= this.x + this.frameWidth && pointY >= this.y && pointY <= this.y + this.frameHeight){
            return true;
        }
        return false;
    }
